...
function OrderCard({ order, isAdmin, isProcessing, onAccept, onUpdateStatus, onCancel, index }) {
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs sm:text-sm font-semibold text-slate-500">
              <span className="flex items-center gap-1"><Calendar size={12} className="sm:w-3.5 sm:h-3.5" /> {new Date(order.date).toLocaleDateString()}</span>
